        ...
        <main className="mx-auto max-w-6xl px-4 py-5 sm:px-6 lg:px-8 lg:py-6">
          {loading ? (
            ...
            >
              ...
              {loadError.includes('subscription') && (
                <p className="mt-3 text-sm leading-relaxed text-gray-700">
                  Ask an admin to set your account status to active and assign a valid subscription
                  expiry date, then reload this page.
                </p>
              )}
            </div>
          ) : students.length === 0 ? (
            ...
            <div className="space-y-5 rounded-xl border border-emerald-200 bg-white p-4 shadow-sm sm:p-6">
              <div>
                <label htmlFor="student-search" className="mb-1.5 block text-sm font-medium text-gray-700">
                  Search Students
                </label>
                <input
                  id="student-search"
